...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    res.innerHTML = '<span class="eyebrow">GO DEEPER</span><h3>Helpful Daily Vitality resources</h3><div class="resource-grid">' + PRODUCTS.map(function (p, i) { return '<a class="resource-card" href="' + p.href + '" target="_blank" rel="noopener"><div class="card-cover"><img loading="lazy" src="assets/topic-visuals/a-00.svg" alt="' + esc(p.title) + '"></div><div class="inside"><span class="cat">' + p.cat.toUpperCase() + '</span><h3>' + esc(p.title) + '</h3><p>' + esc(p.d) + '</p></div></a>'; }).join('') + '</div>';
